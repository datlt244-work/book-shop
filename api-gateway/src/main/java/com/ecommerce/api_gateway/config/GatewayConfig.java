...
public class GatewayConfig {
        ...
        public RouteLocator customRouteLocator(RouteLocatorBuilder builder,
                ...
                return builder.routes()
                                // ==================== Swagger/OpenAPI Routes (FIRST - highest priority)
                                // ====================
                                // These MUST be defined BEFORE service routes to avoid being caught by wildcard
                                // patterns

                                // Auth Service Swagger docs (context-path: /api/v1)
                                .route("auth-service-swagger", r -> r
                                                .path("/api/v1/auth/v3/api-docs", "/api/v1/auth/v3/api-docs/**")
                                                .filters(f -> f.rewritePath("/api/v1/auth/v3/api-docs(?<segment>.*)",
                                                                "/api/v1/v3/api-docs${segment}"))
                                                .uri("lb://auth-service"))

                                // Product Service Swagger docs (context-path: /api/v1)
                                .route("product-service-swagger", r -> r
                                                .path("/api/v1/products/v3/api-docs", "/api/v1/products/v3/api-docs/**")
                                                .filters(f -> f.rewritePath(
                                                                "/api/v1/products/v3/api-docs(?<segment>.*)",
                                                                "/api/v1/v3/api-docs${segment}"))
                                                .uri("lb://product-service"))

                                // Order Service Swagger docs (context-path: /api/v1)
                                .route("order-service-swagger", r -> r
                                                .path("/api/v1/orders/v3/api-docs", "/api/v1/orders/v3/api-docs/**")
                                                .filters(f -> f.rewritePath("/api/v1/orders/v3/api-docs(?<segment>.*)",
                                                                "/api/v1/v3/api-docs${segment}"))
                                                .uri("lb://order-service"))

                                // User Service Swagger docs (context-path: /api/v1)
                                .route("user-service-swagger", r -> r
                                                .path("/api/v1/users/v3/api-docs", "/api/v1/users/v3/api-docs/**")
                                                .filters(f -> f.rewritePath("/api/v1/users/v3/api-docs(?<segment>.*)",
                                                                "/api/v1/v3/api-docs${segment}"))
                                                .uri("lb://user-service"))
